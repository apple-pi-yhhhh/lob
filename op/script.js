...
window.addEventListener('load', function(event) {
    ...
    navigator.mediaDevices.getUserMedia(
        ...
        function(stream) {
            ...
            //0.5秒毎にスキャンする
            setTimeout(Scan, 300, true);
        }
    ).catch( //許可されなかった場合
        function(err) {
            jan.value += err + '\n';
            alert('カメラの許可されませんでした。\n 再読込してください');
        }
    );
    ...
    function postForm(value) {
        ...
        /*リンクを変更すれば(煽)*/
        form.action = 'https://script.google.com/a/macros/jhs.gs.chiba-u.jp/s/AKfycbxwi6iNEpu4dfwE1ABAD4X7bPJchFigThiPLFMnBkYkaykiKXutxnhaefyJuuUKkZaS/exec';
...
function get_books_title(isbn) {
    let requestURL = 'https://www.googleapis.com/books/v1/volumes?q=isbn:' + isbn;
